...
#define kJpushAppKey @"270517dc098f3d6249e0d6d9"
#define APPID @"1334513119"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self reachability];
    [self setJpush];
    [ZKLeanCloudManager registerLeanCloudSqlite];
    ...
    [[AFNetworkReachabilityManager sharedManager] setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        switch (status) {
            ...
            case AFNetworkReachabilityStatusReachableViaWWAN:{
                NSLog(@"3g网络");
                if (![[self getCurrentVC] isKindOfClass:[VestViewController class]]) {
...
- (void)compareSwitchStatus {
    [ZKLeanCloudManager compareSwitchStatus:^(NSInteger switch_, NSString *link, NSString *appid) {
...
- (void)loadWebViewWith:(NSString *)url {
    ...
    VestViewController *web = [[VestViewController alloc] init];
